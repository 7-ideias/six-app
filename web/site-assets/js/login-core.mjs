...
export const LOGIN_DICTIONARY = Object.freeze({
  pt: Object.freeze({
    title: 'SixoApp - Entrar',
    description: 'Acesse sua operação no SixoApp para acompanhar vendas, atendimentos, clientes, equipe e financeiro.',
    ogTitle: 'SixoApp - Entrar',
    ogDescription: 'Login seguro para acessar sua operação no SixoApp.',
    twitterTitle: 'SixoApp - Entrar',
    twitterDescription: 'Acesse vendas, atendimentos, clientes, equipe e financeiro no SixoApp.',
  ...
  en: Object.freeze({
    title: 'SixoApp - Sign In',
    description: 'Access your SixoApp operation to follow sales, service, customers, team and finance.',
    ogTitle: 'SixoApp - Sign In',
    ogDescription: 'Secure sign-in to access your SixoApp operation.',
    twitterTitle: 'SixoApp - Sign In',
    twitterDescription: 'Access sales, service, customers, team and finance in SixoApp.',
  ...
  es: Object.freeze({
    title: 'SixoApp - Entrar',
    description: 'Accede a tu operación en SixoApp para acompañar ventas, atención, clientes, equipo y finanzas.',
    ogTitle: 'SixoApp - Entrar',
    ogDescription: 'Login seguro para acceder a tu operación en SixoApp.',
    twitterTitle: 'SixoApp - Entrar',
    twitterDescription: 'Accede a ventas, atención, clientes, equipo y finanzas en SixoApp.',

(function () {
  ...
  var dictionary = {
    pt: {
      title: 'SixoApp - Gestão em Web, Android e iOS',
      description: 'SixoApp organiza vendas, orçamentos, atendimentos técnicos, clientes, equipe e financeiro em uma plataforma para usar na Web, Android e iOS.',
      ogTitle: 'SixoApp',
      ogDescription: 'Gestão completa para quem vende produtos e presta serviços técnicos na Web, Android e iOS.',
      twitterTitle: 'SixoApp',
      ...
      'hero.lead': 'O SixoApp conecta vendas, orçamentos, atendimentos, clientes, equipe e financeiro em um só lugar, com clareza para operar hoje e acompanhar o crescimento amanhã.',
      ...
      'hero.platforms.aria': 'Plataformas do SixoApp',
      'hero.management.aria': 'Apoios de gestão',
      'hero.carousel.aria': 'Slides da Home',
      'hero.tabs.aria': 'Destaques do SixoApp',
      ...
      'preview.aria': 'Prévia Web e mobile do SixoApp',
      ...
      'trust.aria': 'Diferenciais do SixoApp',
      ...
      'resources.lead': 'O SixoApp reúne módulos essenciais para comércios que combinam produtos, serviços, clientes e gestão diária.',
      ...
      'segments.lead': 'O SixoApp atende rotinas de comércio e prestação de serviço técnico com processos, pessoas e financeiro no mesmo ambiente.',
      ...
      'plans.card.title': 'Conheça as opções do SixoApp',
      ...
      'faq.lead': 'Respostas diretas para entender se o SixoApp se encaixa na sua rotina.',
      'faq.one.question': 'Para quais tipos de negócio o SixoApp serve?',
      ...
      'faq.three.answer': 'Sim. O SixoApp considera permissões para limitar ações sensíveis de acordo com o papel do colaborador.',
      'faq.four.question': 'O SixoApp funciona no celular e computador?',
      ...
      'faq.offline.question': 'O SixoApp funciona sem internet?',
      'faq.offline.answer': 'Não. O SixoApp é um sistema online e exige conexão com a internet para manter informações sincronizadas.',
      ...
      'hero.image.alt': 'Símbolo do SixoApp',
      'hero.brand.tagline': 'Tudo conectado. Tudo sob controle.',
      ...
      'showcase.aria': 'SixoApp na rotina',
      ...
      'showcase.platform.title': 'O SixoApp inteiro acompanha você.',
      ...
      'solutions.lead': 'O SixoApp reduz a fragmentação do dia a dia conectando informações que normalmente ficam espalhadas.',
      'solutions.pain.label': 'A dor',
      'solutions.answer.label': 'A solução SixoApp',
      ...
      'solutions.cta.body': 'Conheça a experiência do SixoApp e veja como ela se encaixa na sua operação.',
      ...
      'plans.options.body': 'Compare as opções do SixoApp em uma etapa própria e segura.',
      ...
      'final.editorial.title': 'Comece a organizar o seu negócio com o SixoApp.',
      'final.editorial.body': 'Crie uma conta ou entre para continuar de onde parou.',
      'footer.solutions': 'Soluções',
      'footer.rights': 'Todos os direitos reservados.'
    },
    en: {
      title: 'SixoApp - Management on Web, Android and iOS',
      description: 'SixoApp organizes sales, quotes, technical service, customers, teams and finance in a platform for Web, Android and iOS.',
      ogTitle: 'SixoApp',
      ...
      'hero.lead': 'SixoApp connects sales, quotes, service, customers, teams and finance in one place, with clarity to operate today and follow growth tomorrow.',
      ...
      'hero.platforms.aria': 'SixoApp platforms',
      'hero.management.aria': 'Management support',
      'hero.carousel.aria': 'Home slides',
      'hero.tabs.aria': 'SixoApp highlights',
      ...
      'preview.aria': 'SixoApp Web and mobile preview',
      ...
      'trust.platforms.body': 'Use SixoApp on desktop and mobile, with an experience designed for real operations.',
      ...
      'resources.lead': 'SixoApp brings essential modules together for businesses that combine products, services, customers and daily management.',
      ...
      'segments.lead': 'SixoApp supports commerce and technical service routines with processes, people and finance in the same workspace.',
      ...
      'plans.card.title': 'Explore SixoApp options',
      ...
      'faq.lead': 'Direct answers to understand whether SixoApp fits your routine.',
      'faq.one.question': 'What types of business is SixoApp for?',
      ...
      'faq.three.answer': 'Yes. SixoApp considers permissions to limit sensitive actions according to each collaborator role.',
      'faq.four.question': 'Does SixoApp work on mobile and desktop?',
      'faq.four.answer': 'Yes. SixoApp includes Web, Android and iOS, with routines for real operations on mobile too.',
      ...
      'faq.offline.question': 'Does SixoApp work without internet?',
      'faq.offline.answer': 'No. SixoApp is an online system and requires an internet connection to keep information synchronized.',
      ...
      'hero.image.alt': 'SixoApp symbol',
      'hero.brand.tagline': 'Everything connected. Everything under control.',
      ...
      'showcase.aria': 'SixoApp in daily operations',
      ...
      'showcase.platform.kicker': 'Web + Android + iOS',
      'showcase.platform.title': 'The entire SixoApp goes with you.',
      ...
      'solutions.lead': 'SixoApp reduces daily fragmentation by connecting information that normally remains scattered.',
      'solutions.pain.label': 'The problem',
      'solutions.answer.label': 'The SixoApp solution',
      ...
      'solutions.cta.body': 'Explore the SixoApp experience and see how it fits your operation.',
      ...
      'plans.options.body': 'Compare SixoApp options in a dedicated, secure step.',
      ...
      'final.editorial.title': 'Start organizing your business with SixoApp.',
      'final.editorial.body': 'Create an account or sign in to continue where you left off.',
      'footer.solutions': 'Solutions',
      'footer.rights': 'All rights reserved.'
    },
    es: {
      title: 'SixoApp - Gestión en Web, Android e iOS',
      description: 'SixoApp organiza ventas, presupuestos, atención técnica, clientes, equipo y finanzas en una plataforma para usar en Web, Android e iOS.',
      ogTitle: 'SixoApp',
      ...
      'hero.lead': 'SixoApp conecta ventas, presupuestos, atención, clientes, equipo y finanzas en un solo lugar, con claridad para operar hoy y acompañar el crecimiento mañana.',
      ...
      'hero.platforms.aria': 'Plataformas de SixoApp',
      'hero.management.aria': 'Apoyos de gestión',
      'hero.carousel.aria': 'Slides de la Home',
      'hero.tabs.aria': 'Aspectos destacados de SixoApp',
      'hero.prev': 'Slide anterior',
      ...
      'preview.aria': 'Vista Web y mobile de SixoApp',
      ...
      'trust.aria': 'Diferenciales de SixoApp',
      'trust.allInOne': 'Todo en un solo lugar',
      'trust.allInOne.body': 'Ventas, servicios, clientes y finanzas integrados y organizados.',
      'trust.platforms': 'Web, Android e iOS',
      'trust.platforms.body': 'Usa SixoApp en la computadora y también en el celular, con experiencia pensada para operación real.',
      ...
      'resources.lead': 'SixoApp reúne módulos esenciales para comercios que combinan productos, servicios, clientes y gestión diaria.',
      ...
      'segments.lead': 'SixoApp atiende rutinas de comercio y prestación de servicio técnico con procesos, personas y finanzas en el mismo ambiente.',
      ...
      'plans.card.title': 'Conoce las opciones de SixoApp',
      ...
      'faq.lead': 'Respuestas directas para entender si SixoApp encaja en tu rutina.',
      'faq.one.question': '¿Para qué tipos de negocio sirve SixoApp?',
      ...
      'faq.three.answer': 'Sí. SixoApp considera permisos para limitar acciones sensibles según el rol del colaborador.',
      'faq.four.question': '¿SixoApp funciona en celular y computadora?',
      'faq.four.answer': 'Sí. SixoApp contempla Web, Android e iOS, con rutinas para operación real también en mobile.',
      ...
      'faq.offline.question': '¿SixoApp funciona sin internet?',
      'faq.offline.answer': 'No. SixoApp es un sistema online y exige conexión a internet para mantener la información sincronizada.',
      ...
      'hero.image.alt': 'Símbolo de SixoApp',
      'hero.brand.tagline': 'Todo conectado. Todo bajo control.',
      ...
      'showcase.aria': 'SixoApp en la rutina',
      ...
      'showcase.platform.title': 'El SixoApp completo te acompaña.',
      ...
      'solutions.lead': 'SixoApp reduce la fragmentación diaria conectando información que normalmente queda dispersa.',
      'solutions.pain.label': 'El problema',
      'solutions.answer.label': 'La solución SixoApp',
      ...
      'solutions.cta.body': 'Conoce la experiencia de SixoApp y descubre cómo se adapta a tu operación.',
      ...
      'plans.options.body': 'Compara las opciones de SixoApp en una etapa propia y segura.',
      ...
      'final.editorial.title': 'Comienza a organizar tu negocio con SixoApp.',

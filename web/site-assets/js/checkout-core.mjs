...
export const CHECKOUT_DICTIONARY = Object.freeze({
  pt: Object.freeze({
    title: 'SixoApp - Checkout',
    description: 'Escolha um plano público do SixoApp e mantenha o checkout em modo simulado até a integração de pagamento.',
    ogTitle: 'SixoApp - Checkout',
    ogDescription: 'Checkout público em HTML para selecionar um plano do SixoApp.',
    twitterTitle: 'SixoApp - Checkout',
    twitterDescription: 'Selecione um plano do SixoApp sem carregar Flutter.',
  ...
  en: Object.freeze({
    title: 'SixoApp - Checkout',
    description: 'Choose a public SixoApp plan and keep checkout simulated until payment integration.',
    ogTitle: 'SixoApp - Checkout',
    ogDescription: 'Public HTML checkout to select a SixoApp plan.',
    twitterTitle: 'SixoApp - Checkout',
    twitterDescription: 'Select a SixoApp plan without loading Flutter.',
  ...
  es: Object.freeze({
    title: 'SixoApp - Checkout',
    description: 'Elige un plan público de SixoApp y mantén el checkout simulado hasta la integración de pago.',
    ogTitle: 'SixoApp - Checkout',
    ogDescription: 'Checkout público en HTML para seleccionar un plan de SixoApp.',
    twitterTitle: 'SixoApp - Checkout',
    twitterDescription: 'Selecciona un plan de SixoApp sin cargar Flutter.',

...
export const REGISTER_DICTIONARY = Object.freeze({
  pt: Object.freeze({
    title: 'SixoApp - Criar conta',
    description: 'Crie sua conta pública no SixoApp para organizar vendas, atendimentos, clientes, equipe e financeiro.',
    ogTitle: 'SixoApp - Criar conta',
    ogDescription: 'Cadastro público do SixoApp para iniciar a gestão do seu comércio.',
    twitterTitle: 'SixoApp - Criar conta',
    twitterDescription: 'Comece sua conta no SixoApp com login e senha.',
    'access.skip': 'Ir para o formulário de cadastro',
    'brand.aria': 'SixoApp',
    'nav.aria': 'Navegação de cadastro',
    'nav.home': 'Voltar para a página inicial',
    'language.aria': 'Selecionar idioma',
    'context.eyebrow': 'Seu espaço SixoApp',
    'context.title': 'Comece com clareza desde o primeiro acesso.',
    'context.body': 'Crie seu acesso e dê o primeiro passo para organizar sua operação em uma experiência simples, conectada e segura.',
    ...
    'form.title': 'Criar conta SixoApp',
    ...
    'success.body': 'Sua conta foi criada com sucesso. Faça login para começar a usar o SixoApp.',
  ...
  en: Object.freeze({
    title: 'SixoApp - Create Account',
    description: 'Create your public SixoApp account to organize sales, service, customers, team and finance.',
    ogTitle: 'SixoApp - Create Account',
    ogDescription: 'SixoApp public registration to start managing your business.',
    twitterTitle: 'SixoApp - Create Account',
    twitterDescription: 'Start your SixoApp account with login and password.',
    'access.skip': 'Skip to the registration form',
    'brand.aria': 'SixoApp',
    'nav.aria': 'Registration navigation',
    'nav.home': 'Back to the home page',
    'language.aria': 'Select language',
    'context.eyebrow': 'Your SixoApp space',
    'context.title': 'Start with clarity from your very first sign-in.',
    'context.body': 'Create your access and take the first step toward organizing your operation in a simple, connected and secure experience.',
    ...
    'form.title': 'Create a SixoApp account',
    ...
    'success.body': 'Your account was created successfully. Sign in to start using SixoApp.',
  ...
  es: Object.freeze({
    title: 'SixoApp - Crear cuenta',
    description: 'Crea tu cuenta pública en SixoApp para organizar ventas, atención, clientes, equipo y finanzas.',
    ogTitle: 'SixoApp - Crear cuenta',
    ogDescription: 'Registro público de SixoApp para iniciar la gestión de tu comercio.',
    twitterTitle: 'SixoApp - Crear cuenta',
    twitterDescription: 'Comienza tu cuenta en SixoApp con login y contraseña.',
    'access.skip': 'Ir al formulario de registro',
    'brand.aria': 'SixoApp',
    'nav.aria': 'Navegacion de registro',
    'nav.home': 'Volver a la página inicial',
    'language.aria': 'Seleccionar idioma',
    'context.eyebrow': 'Tu espacio SixoApp',
    'context.title': 'Comienza con claridad desde el primer acceso.',
    'context.body': 'Crea tu acceso y da el primer paso para organizar tu operación en una experiencia simple, conectada y segura.',
    ...
    'form.title': 'Crear cuenta SixoApp',
    ...
    'success.body': 'Tu cuenta fue creada con éxito. Entra para comenzar a usar SixoApp.',

...
export const ONBOARDING_DICTIONARY = Object.freeze({
  pt: Object.freeze({
    title: 'SixApp - Onboarding',
    description: 'Informe o perfil do seu negócio para iniciar o teste guiado do SixApp.',
    ogTitle: 'SixApp - Onboarding',
    ogDescription: 'Onboarding público para preparar seu perfil de teste no SixApp.',
    twitterTitle: 'SixApp - Onboarding',
    twitterDescription: 'Escolha o perfil do seu negócio antes de entrar no SixApp.',
  ...
  en: Object.freeze({
    title: 'SixApp - Onboarding',
    description: 'Enter your business profile to start the guided SixApp trial.',
    ogTitle: 'SixApp - Onboarding',
    ogDescription: 'Public onboarding to prepare your SixApp trial profile.',
    twitterTitle: 'SixApp - Onboarding',
    twitterDescription: 'Choose your business profile before signing in to SixApp.',
  ...
  es: Object.freeze({
    title: 'SixApp - Onboarding',
    description: 'Informa el perfil de tu negocio para iniciar la prueba guiada de SixApp.',
    ogTitle: 'SixApp - Onboarding',
    ogDescription: 'Onboarding público para preparar tu perfil de prueba en SixApp.',
    twitterTitle: 'SixApp - Onboarding',
    twitterDescription: 'Elige el perfil de tu negocio antes de entrar en SixApp.',

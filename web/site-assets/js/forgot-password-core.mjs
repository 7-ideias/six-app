...
export const FORGOT_PASSWORD_DICTIONARY = Object.freeze({
  pt: Object.freeze({
    title: 'SixApp - Recuperar senha',
    description: 'Recupere o acesso ao SixApp com o código enviado ao seu e-mail cadastrado.',
    ogTitle: 'SixApp - Recuperar senha',
    ogDescription: 'Fluxo público de recuperação de senha do SixApp.',
    twitterTitle: 'SixApp - Recuperar senha',
    twitterDescription: 'Receba um código e defina uma nova senha para acessar o SixApp.',
    ...
    'context.item.two': 'Código de 6 dígitos validado pelo backend.',
    'context.item.three': 'Nenhum código ou senha é salvo no navegador.',
    ...
    'success.body': 'Use sua nova senha para entrar no SixApp.',
  ...
  en: Object.freeze({
    title: 'SixApp - Recover Password',
    description: 'Recover access to SixApp with the code sent to your registered email.',
    ogTitle: 'SixApp - Recover Password',
    ogDescription: 'SixApp public password recovery flow.',
    twitterTitle: 'SixApp - Recover Password',
    twitterDescription: 'Receive a code and set a new password to access SixApp.',
    ...
    'context.item.two': 'Six-digit code validated by the backend.',
    'context.item.three': 'No code or password is stored in the browser.',
    ...
    'success.body': 'Use your new password to sign in to SixApp.',
  ...
  es: Object.freeze({
    title: 'SixApp - Recuperar contraseña',
    description: 'Recupera el acceso a SixApp con el código enviado a tu e-mail registrado.',
    ogTitle: 'SixApp - Recuperar contraseña',
    ogDescription: 'Flujo público de recuperación de contraseña de SixApp.',
    twitterTitle: 'SixApp - Recuperar contraseña',
    twitterDescription: 'Recibe un código y define una nueva contraseña para acceder a SixApp.',
    ...
    'context.item.two': 'Código de 6 dígitos validado por el backend.',
    'context.item.three': 'No se guarda ningún código o contraseña en el navegador.',
    ...
    'success.body': 'Usa tu nueva contraseña para entrar en SixApp.',

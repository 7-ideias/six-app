...
class _AiFeedbackDashboardCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final String subtitle =
        language == 'en'
            ? 'Measure how users rate the answers generated by SixoApp.'
            : language == 'es'
            ? 'Mide cómo los usuarios evalúan las respuestas generadas por SixoApp.'
            : 'Meça como os usuários avaliam as respostas geradas pelo SixoApp.';

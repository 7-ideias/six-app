...
class _EtiquetaEditorWebPageState extends State<EtiquetaEditorWebPage> {
      ...
      child: Column(
        children: <Widget>[
          SixWebDashboardHeader(
            ...
            title: widget.initialModel == null
                ? _tr(
          ...
          children: <Widget>[
            ...
            TextField(
              ...
              decoration: _inputDecoration(
                _tr('labels.editor.name', 'Nome do modelo', 'Template name', 'Nombre de la plantilla'),
                Icons.edit_outlined,
              ),
            ...
            TextField(
              ...
              maxLines: 2,
              decoration: _inputDecoration(
                _tr('labels.editor.description', 'Descrição (opcional)', 'Description (optional)', 'Descripción (opcional)'),
            ...
            const SizedBox(height: 10),
            _MenuField(
              label: _tr('labels.editor.format', 'Formato', 'Format', 'Formato'),
            ...
            const SizedBox(height: 10),
            _MenuField(
              label: _tr('labels.editor.orientation', 'Orientação', 'Orientation', 'Orientación'),
            ...
            _twoNumbers(
              first: _numberField(
                ...
                onChanged: (double value) => _setPaper(
                  _model.papel.copyWith(larguraMm: value),
                ),
              ),
              second: _numberField(
                ...
                enabled: _model.papel.preset == 'CUSTOM',
                onChanged: (double value) => _setPaper(
                  _model.papel.copyWith(alturaMm: value),
                ),
              ),
            ),
            const SizedBox(height: 20),
            _sectionTitle(
              _tr('labels.editor.grid', 'Grade de etiquetas', 'Label grid', 'Cuadrícula de etiquetas'),
            ...
            _twoNumbers(
              first: _intField(
                keyName: 'columns',
                label: _tr('labels.editor.columns', 'Colunas', 'Columns', 'Columnas'),
                value: _model.grade.colunas,
                onChanged: (int value) => _setGrade(
                  _model.grade.copyWith(colunas: value),
                ),
              ),
              second: _intField(
                keyName: 'rows',
                ...
                onChanged: (int value) => _setGrade(
                  _model.grade.copyWith(linhas: value),
                ),
              ),
            ),
            const SizedBox(height: 10),
            _twoNumbers(
              first: _numberField(
                keyName: 'label-width',
                label: _tr('labels.editor.labelWidth', 'Etiqueta L', 'Label W', 'Etiqueta A'),
                value: _model.etiqueta.larguraMm,
                onChanged: (double value) => _setLabelSize(
                  _model.etiqueta.copyWith(larguraMm: value),
                ),
              ),
              second: _numberField(
                keyName: 'label-height',
                label: _tr('labels.editor.labelHeight', 'Etiqueta A', 'Label H', 'Etiqueta H'),
            ...
            _twoNumbers(
              first: _numberField(
                keyName: 'gap-h',
                label: _tr('labels.editor.horizontalGap', 'Gap H', 'H gap', 'Espacio H'),
                value: _model.grade.espacamentoHorizontalMm,
                onChanged: (double value) => _setGrade(
                  _model.grade.copyWith(espacamentoHorizontalMm: value),
                ),
              ),
              second: _numberField(
                keyName: 'gap-v',
                label: _tr('labels.editor.verticalGap', 'Gap V', 'V gap', 'Espacio V'),
            ...
            const SizedBox(height: 12),
            Text(
              _tr('labels.editor.margins', 'Margens (mm)', 'Margins (mm)', 'Márgenes (mm)'),
            ...
            _twoNumbers(
              first: _numberField(
                keyName: 'margin-left',
                label: _tr('labels.editor.left', 'Esquerda', 'Left', 'Izquierda'),
                value: _model.grade.margemEsquerdaMm,
                onChanged: (double value) => _setGrade(_model.grade.copyWith(margemEsquerdaMm: value)),
              ),
              second: _numberField(
                keyName: 'margin-right',
                label: _tr('labels.editor.right', 'Direita', 'Right', 'Derecha'),
                value: _model.grade.margemDireitaMm,
                onChanged: (double value) => _setGrade(_model.grade.copyWith(margemDireitaMm: value)),
              ),
            ),
            const SizedBox(height: 8),
            _twoNumbers(
              first: _numberField(
                ...
                onChanged: (double value) => _setGrade(_model.grade.copyWith(margemSuperiorMm: value)),
              ),
              second: _numberField(
                keyName: 'margin-bottom',
                label: _tr('labels.editor.bottom', 'Inferior', 'Bottom', 'Inferior'),
                value: _model.grade.margemInferiorMm,
                onChanged: (double value) => _setGrade(_model.grade.copyWith(margemInferiorMm: value)),
              ),
            ),
            const SizedBox(height: 20),
            _sectionTitle(
              _tr('labels.editor.sheetPreview', 'Preview da folha', 'Sheet preview', 'Vista previa de la hoja'),
        ...
        child: Column(
          ...
          children: <Widget>[
              ...
              children: <Widget>[
                Expanded(
                  child: Column(
                    ...
                    children: <Widget>[
                      Text(
                        _tr('labels.editor.labelCanvas', 'Etiqueta', 'Label canvas', 'Etiqueta'),
                ...
                PopupMenuButton<_ElementPreset>(
                  tooltip: _tr('labels.editor.addElement', 'Adicionar elemento', 'Add element', 'Agregar elemento'),
                  onSelected: _addElement,
                  itemBuilder: (BuildContext context) => _elementPresets
                      .map(( _ElementPreset preset) => PopupMenuItem<_ElementPreset>(
                            value: preset,
                            child: Row(
                              children: <Widget>[
                  ...
                  child: FilledButton.tonalIcon(
                    ...
                    label: Text(_tr('labels.editor.add', 'Adicionar', 'Add', 'Agregar')),
                  ),
                ),
              ],
            ),
            ...
            Expanded(
              child: LayoutBuilder(
                builder: (BuildContext context, BoxConstraints constraints) {
                  final double availableWidth = math.max(180.0, constraints.maxWidth - 50).toDouble();
                  final double availableHeight = math.max(150.0, constraints.maxHeight - 45).toDouble();
                  final double scale = math.min(
                    availableWidth / math.max(1, _model.etiqueta.larguraMm),
                    availableHeight / math.max(1, _model.etiqueta.alturaMm),
                  ).clamp(1.0, 16.0).toDouble();
                              ...
                              children: <Widget>[
                                for (final EtiquetaElemento element in _model.elementos)
                                  _EditableElement(
                                    ...
                                    onSelect: () => setState(() => _selectedElementId = element.id),
                                    onMove: (Offset delta) => _moveElement(element, delta, scale),
                                    onResize: (Offset delta) => _resizeElement(element, delta, scale),
                                  ),
                              ],
                            ),
                          ),
      ...
      child: SingleChildScrollView(
        ...
        child: element == null
            ? Column(
                ...
                children: <Widget>[
                  Text(
                    _tr('labels.editor.elements', 'Elementos', 'Elements', 'Elementos'),
                    style: theme.textTheme.titleMedium?.copyWith(fontWeight: FontWeight.w900),
                  ),
                  const SizedBox(height: 12),
                    ...
                    for (final EtiquetaElemento item in _model.elementos)
                      Padding(
                        ...
                        child: OutlinedButton.icon(
                          onPressed: () => setState(() => _selectedElementId = item.id),
                          icon: Icon(_iconForElement(item), size: 18),
                          label: Align(
                            alignment: Alignment.centerLeft,
                            child: Text(_bindingLabel(item.bindingKey), overflow: TextOverflow.ellipsis),
                          ),
                        ),
                      ),
                ],
      ...
      children: <Widget>[
        Row(
          children: <Widget>[
            ...
            IconButton(
              tooltip: _tr('labels.editor.deleteElement', 'Excluir elemento', 'Delete element', 'Eliminar elemento'),
        ...
        _sectionTitle(
          _tr('labels.editor.positionSize', 'Posição e tamanho', 'Position and size', 'Posición y tamaño'),
        ...
        _twoNumbers(
          first: _numberField(
            ...
            label: 'X',
            value: element.xMm,
            onChanged: (double value) => _updateElement(element.copyWith(xMm: value)),
          ),
          second: _numberField(
            keyName: 'element-y-${element.id}',
            label: 'Y',
            value: element.yMm,
            onChanged: (double value) => _updateElement(element.copyWith(yMm: value)),
          ),
        ),
        const SizedBox(height: 8),
        _twoNumbers(
          first: _numberField(
            ...
            onChanged: (double value) => _updateElement(element.copyWith(larguraMm: value)),
          ),
          second: _numberField(
            keyName: 'element-h-${element.id}',
            label: _tr('labels.editor.height', 'Altura', 'Height', 'Alto'),
            value: element.alturaMm,
            onChanged: (double value) => _updateElement(element.copyWith(alturaMm: value)),
          ),
        ),
        if (isText) ...<Widget>[
          const SizedBox(height: 18),
          ...
          if (element.bindingKey == 'FREE_TEXT')
            TextField(
              key: ValueKey<String>('free-text-${element.id}-${element.propriedades['text']}'),
              controller: TextEditingController(text: element.propriedades['text']?.toString() ?? ''),
              decoration: _inputDecoration(
                _tr('labels.editor.freeText', 'Texto livre', 'Free text', 'Texto libre'),
                Icons.short_text_rounded,
              ),
              onChanged: (String value) => _updateProperties(element, <String, dynamic>{'text': value}),
            ),
          if (element.bindingKey == 'FREE_TEXT') const SizedBox(height: 10),
          _numberField(
            keyName: 'font-size-${element.id}',
            label: _tr('labels.editor.fontSize', 'Tamanho da fonte (pt)', 'Font size (pt)', 'Tamaño de fuente (pt)'),
            value: _propertyDouble(element, 'fontSize', 10),
            suffix: 'pt',
            onChanged: (double value) => _updateProperties(element, <String, dynamic>{'fontSize': value}),
          ),
          const SizedBox(height: 10),
          SwitchListTile.adaptive(
            contentPadding: EdgeInsets.zero,
            title: Text(_tr('labels.editor.bold', 'Negrito', 'Bold', 'Negrita')),
            value: _propertyBool(element, 'bold', false),
            onChanged: (bool value) => _updateProperties(element, <String, dynamic>{'bold': value}),
          ),
          _MenuField(
            label: _tr('labels.editor.alignment', 'Alinhamento', 'Alignment', 'Alineación'),
            value: _alignLabel(element.propriedades['align']?.toString() ?? 'LEFT'),
            values: const <String>['LEFT', 'CENTER', 'RIGHT'],
            valueLabel: _alignLabel,
            onSelected: (String value) => _updateProperties(element, <String, dynamic>{'align': value}),
          ),
        ],
        if (isBarcode) ...<Widget>[
          const SizedBox(height: 18),
          _sectionTitle(
            _tr('labels.editor.barcode', 'Código de barras', 'Barcode', 'Código de barras'),
            Icons.view_week_outlined,
          ),
          const SizedBox(height: 10),
          _MenuField(
            label: _tr('labels.editor.symbology', 'Simbologia', 'Symbology', 'Simbología'),
            value: element.propriedades['barcodeType']?.toString() ?? 'CODE128',
            values: const <String>['CODE128', 'CODE39', 'EAN13', 'EAN8', 'UPCA', 'ITF'],
            valueLabel: (String value) => value,
            onSelected: (String value) => _updateProperties(element, <String, dynamic>{'barcodeType': value}),
          ),
          const SizedBox(height: 6),
          SwitchListTile.adaptive(
            contentPadding: EdgeInsets.zero,
            title: Text(_tr('labels.editor.showCode', 'Exibir código abaixo das barras', 'Show value below bars', 'Mostrar valor bajo las barras')),
            value: _propertyBool(element, 'showText', true),
            onChanged: (bool value) => _updateProperties(element, <String, dynamic>{'showText': value}),
          ),
        ],
        const SizedBox(height: 18),
        Container(
  ...
  String? _geometryError() {
    ...
    final double requiredWidth = _model.grade.margemEsquerdaMm +
        _model.grade.margemDireitaMm +
        _model.grade.colunas * _model.etiqueta.larguraMm +
        math.max(0, _model.grade.colunas - 1) * _model.grade.espacamentoHorizontalMm;
    final double requiredHeight = _model.grade.margemSuperiorMm +
        _model.grade.margemInferiorMm +
        _model.grade.linhas * _model.etiqueta.alturaMm +
        math.max(0, _model.grade.linhas - 1) * _model.grade.espacamentoVerticalMm;
  ...
  void _applyPaperPreset(String preset) {
    final EtiquetaModelo next = switch (preset) {
      ...
      'LETTER' => _model.copyWith(
          papel: const EtiquetaPapel(preset: 'LETTER', larguraMm: 215.9, alturaMm: 279.4),
          grade: const EtiquetaGrade(
            colunas: 3,
            linhas: 7,
            margemSuperiorMm: 10,
  ...
  void _addElement(_ElementPreset preset) {
    ...
    final double maxWidth = math.max(4.0, _model.etiqueta.larguraMm - 6).toDouble();
    final double maxHeight = math.max(4.0, _model.etiqueta.alturaMm - 6).toDouble();
    final EtiquetaElemento element = EtiquetaElemento(
      ...
      xMm: 3,
      yMm: math.min(3.0 + ((index - 1) * 2.0), math.max(0.0, _model.etiqueta.alturaMm - 8)).toDouble(),
    ...
    setState(() {
      _model = _model.copyWith(elementos: <EtiquetaElemento>[..._model.elementos, element]);
  ...
  void _deleteElement(String id) {
    setState(() {
      _model = _model.copyWith(
        elementos: _model.elementos.where((EtiquetaElemento item) => item.id != id).toList(growable: false),
      );
      _selectedElementId = _model.elementos.isEmpty ? null : _model.elementos.first.id;
    });
  }

  void _moveElement(EtiquetaElemento element, Offset deltaPx, double scale) {
    final double maxX = math.max(0, _model.etiqueta.larguraMm - element.larguraMm).toDouble();
    final double maxY = math.max(0, _model.etiqueta.alturaMm - element.alturaMm).toDouble();
  ...
  void _resizeElement(EtiquetaElemento element, Offset deltaPx, double scale) {
    final double maxWidth = math.max(2.0, _model.etiqueta.larguraMm - element.xMm).toDouble();
    final double maxHeight = math.max(2.0, _model.etiqueta.alturaMm - element.yMm).toDouble();
    _updateElement(element.copyWith(
      larguraMm: (element.larguraMm + deltaPx.dx / scale).clamp(2.0, maxWidth).toDouble(),
      alturaMm: (element.alturaMm + deltaPx.dy / scale).clamp(2.0, maxHeight).toDouble(),
    ));
  }
  ...
  void _updateProperties(EtiquetaElemento element, Map<String, dynamic> changes) {
    _updateElement(element.copyWith(
      propriedades: <String, dynamic>{...element.propriedades, ...changes},
    ));
  }

  void _setPaper(EtiquetaPapel paper) => setState(() => _model = _model.copyWith(papel: paper));
  void _setGrade(EtiquetaGrade grade) => setState(() => _model = _model.copyWith(grade: grade));
  void _setLabelSize(EtiquetaTamanho size) => setState(() => _model = _clampElements(_model.copyWith(etiqueta: size)));

  EtiquetaModelo _clampElements(EtiquetaModelo model) {
    return model.copyWith(
      elementos: model.elementos.map((EtiquetaElemento element) {
        final double width = element.larguraMm.clamp(2.0, math.max(2.0, model.etiqueta.larguraMm)).toDouble();
        final double height = element.alturaMm.clamp(2.0, math.max(2.0, model.etiqueta.alturaMm)).toDouble();
        return element.copyWith(
          larguraMm: width,
          alturaMm: height,
          xMm: element.xMm.clamp(0.0, math.max(0.0, model.etiqueta.larguraMm - width)).toDouble(),
          yMm: element.yMm.clamp(0.0, math.max(0.0, model.etiqueta.alturaMm - height)).toDouble(),
        );
      }).toList(growable: false),
    );
  }
  ...
  String _previewText(EtiquetaElemento element) {
    switch (element.bindingKey) {
      case 'PRODUCT_NAME':
        return _tr('labels.preview.product', 'Produto exemplo', 'Sample product', 'Producto de ejemplo');
      case 'PRODUCT_PRICE':
      ...
      case 'PRODUCT_INTERNAL_CODE':
        return 'ABC123';
      case 'COMPANY_NAME':
        return _tr('labels.preview.company', 'Nome do comércio', 'Business name', 'Nombre del comercio');
      case 'FREE_TEXT':
        return element.propriedades['text']?.toString() ?? _tr('labels.preview.freeText', 'Texto livre', 'Free text', 'Texto libre');
      default:
  ...
  double _propertyDouble(EtiquetaElemento element, String key, double fallback) {
  ...
  InputDecoration _inputDecoration(String label, IconData? icon, {String? suffixText}) {
    final WebThemeTokens tokens = WebThemeTokens.of(context);
  ...
  String _paperLabel(String value) => switch (value) {
        'A4' => 'A4 · 210 × 297 mm',
        'LETTER' => _tr('labels.paper.letter', 'Carta · 215,9 × 279,4 mm', 'Letter · 215.9 × 279.4 mm', 'Carta · 215,9 × 279,4 mm'),
  ...
  String _orientationLabel(String value) => value == 'LANDSCAPE'
      ? _tr('labels.orientation.landscape', 'Paisagem', 'Landscape', 'Horizontal')
      : _tr('labels.orientation.portrait', 'Retrato', 'Portrait', 'Vertical');
  ...
  String _bindingLabel(String value) => switch (value) {
        'PRODUCT_NAME' => _tr('labels.binding.productName', 'Nome do produto', 'Product name', 'Nombre del producto'),
        'PRODUCT_PRICE' => _tr('labels.binding.productPrice', 'Preço do produto', 'Product price', 'Precio del producto'),
        'PRODUCT_BARCODE' => _tr('labels.binding.productBarcode', 'Código de barras do produto', 'Product barcode', 'Código de barras del producto'),
        'PRODUCT_INTERNAL_CODE' => _tr('labels.binding.internalCode', 'Código interno', 'Internal code', 'Código interno'),
        'COMPANY_NAME' => _tr('labels.binding.companyName', 'Nome do comércio', 'Business name', 'Nombre del comercio'),
        'FREE_TEXT' => _tr('labels.binding.freeText', 'Texto livre', 'Free text', 'Texto libre'),
        _ => value,
      };
  ...
  String _elementPresetLabel(String key) => switch (key) {
        ...
        'BARCODE' => _tr('labels.element.barcode', 'Código de barras', 'Barcode', 'Código de barras'),
        'QRCODE' => 'QR Code',
  ...
  String _fmt(double value) {
    ...
    return value.toStringAsFixed(value.abs() < 10 ? 2 : 1).replaceFirst(RegExp(r'0+$'), '').replaceFirst(RegExp(r'\.$'), '');
  }
              ...
              child: GestureDetector(
                ...
                child: AnimatedContainer(
                  ...
                  child: ClipRRect(
                    ...
                    child: _ElementPreview(element: element, previewText: previewText),
                  ),
                ),
              ),
            ),
          ...
          if (selected)
            Positioned(
              ...
              child: MouseRegion(
                ...
                child: GestureDetector(
                  behavior: HitTestBehavior.opaque,
                  onPanUpdate: (DragUpdateDetails details) => onResize(details.delta),
                  child: Container(
                    width: 15,
                    height: 15,
                    decoration: BoxDecoration(
...
class _SheetPreview extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return LayoutBuilder(
      builder: (BuildContext context, BoxConstraints constraints) {
        final double scale = math.min(
          (constraints.maxWidth - 20) / math.max(1, model.papel.larguraMm),
          (constraints.maxHeight - 20) / math.max(1, model.papel.alturaMm),
        ).clamp(0.1, 5.0).toDouble();
        return Center(
          child: Container(
            ...
            decoration: BoxDecoration(
              ...
              border: Border.all(color: tokens.cardBorder),
              boxShadow: <BoxShadow>[
                BoxShadow(color: Theme.of(context).colorScheme.shadow.withValues(alpha: 0.08), blurRadius: 8),
              ],
            ),
            child: Stack(
              children: <Widget>[
                for (int row = 0; row < model.grade.linhas; row++)
                  for (int column = 0; column < model.grade.colunas; column++)
                    Positioned(
                      left: (model.grade.margemEsquerdaMm + column * (model.etiqueta.larguraMm + model.grade.espacamentoHorizontalMm)) * scale,
                      top: (model.grade.margemSuperiorMm + row * (model.etiqueta.alturaMm + model.grade.espacamentoVerticalMm)) * scale,
                      width: model.etiqueta.larguraMm * scale,
                      height: model.etiqueta.alturaMm * scale,
                      child: DecoratedBox(
                        decoration: BoxDecoration(
                          color: tokens.selectedBackground.withValues(alpha: 0.45),
                          border: Border.all(color: tokens.selectedBorder, width: 0.7),
                        ),
                      ),
                    ),
              ],
...
const List<_ElementPreset> _elementPresets = <_ElementPreset>[
  _ElementPreset(
    ...
    widthMm: 44,
    heightMm: 6,
    properties: <String, dynamic>{'fontSize': 10, 'bold': true, 'align': 'LEFT'},
  ),
  _ElementPreset(
    key: 'PRODUCT_PRICE',
    type: 'TEXT',
    ...
    widthMm: 25,
    heightMm: 7,
    properties: <String, dynamic>{'fontSize': 14, 'bold': true, 'align': 'LEFT'},
  ),
  _ElementPreset(
    key: 'BARCODE',
    type: 'BARCODE',
  ...
  _ElementPreset(
    ...
    widthMm: 28,
    heightMm: 5,
    properties: <String, dynamic>{'fontSize': 8, 'bold': false, 'align': 'LEFT'},
  ),
  _ElementPreset(
    key: 'COMPANY_NAME',
    type: 'TEXT',
  ...
  _ElementPreset(
    ...
    widthMm: 30,
    heightMm: 5,
    properties: <String, dynamic>{'text': 'Texto', 'fontSize': 9, 'bold': false, 'align': 'LEFT'},
  ),
];
...
class _BarcodePreviewPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    int index = 0;
    while (x < size.width) {
      final double width = unit * (index % 5 == 0 ? 3 : index % 3 == 0 ? 2 : 1);
      canvas.drawRect(Rect.fromLTWH(x, 0, math.min(width, size.width - x).toDouble(), size.height), paint);
      x += width + unit;
      index++;
    }
  }
  ...
  @override
  bool shouldRepaint(covariant _BarcodePreviewPainter oldDelegate) => oldDelegate.color != color;
}
...
class _QrPreviewPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    for (int y = 0; y < count; y++) {
      for (int x = 0; x < count; x++) {
        final bool finder = (x < 5 && y < 5) || (x >= count - 5 && y < 5) || (x < 5 && y >= count - 5);
  ...
  @override
  bool shouldRepaint(covariant _QrPreviewPainter oldDelegate) => oldDelegate.color != color;
}

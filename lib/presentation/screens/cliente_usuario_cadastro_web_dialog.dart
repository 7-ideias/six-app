...
void showClienteUsuarioCadastroWebDialog(
  ...
  showDialog<void>(
    ...
    builder:
        (_) => SubPainelCadastroCliente(
          textoDaAppBar:
              cliente == null ? 'Cadastro de Clientes' : 'Edição de Clientes',
...
class _ClienteUsuarioCadastroWebBodyState
  ...
  Widget _summaryCard(BuildContext context) {
    ...
    final WebThemeTokens tokens = WebThemeTokens.of(context);
    final String nome =
        _nome.text.trim().isEmpty ? 'Cliente sem nome' : _nome.text.trim();
              ...
              child: Row(
                ...
                children: <Widget>[
                  Icon(
                    ...
                    color:
                        creditoLiberado ? tokens.success : tokens.statusNeutral,
                    size: 20,
                  ),
                  ...
                  Expanded(
                    child: Text(
                      creditoLiberado
                          ? 'Compra a prazo liberada com limite de R\$ ${_limite.text.trim()} e prazo de ${_prazo.text.trim()} dias.'
        ...
        child:
            compact
                ? Column(
                  ...
                  children: <Widget>[
                    Text(
                      'Revise os dados obrigatórios antes de salvar.',
                      style: theme.textTheme.bodyMedium?.copyWith(
                        color: tokens.primaryText,
                        fontWeight: FontWeight.w800,
                      ),

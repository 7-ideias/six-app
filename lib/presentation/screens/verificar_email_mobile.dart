...
class VerificarEmailMobile extends StatefulWidget {
  ...
  @override
  State<VerificarEmailMobile> createState() => _VerificarEmailMobileState();
}

class _VerificarEmailMobileState extends State<VerificarEmailMobile> {
  ...
  void _onDigitChanged(int index, String value) {
    // Paste de 6 dígitos no primeiro campo
    if (value.length > 1) {
  ...
  Future<void> _reenviarCodigo() async {
    ...
    try {
      await _otpService.enviarCodigo(widget.email);
      if (!mounted) return;
            ...
            children: [
              ...
              RichText(
                ...
                text: TextSpan(
                  ...
                  children: [
                    const TextSpan(
                      text: 'Digite o código de 6 dígitos que\nenviamos para o e-mail ',
                    ),
                    TextSpan(
                      text: widget.email,
                      style: TextStyle(
    ...
    return SizedBox(
      ...
      child: Focus(
        ...
        child: TextField(
          ...
          maxLength: 6, // aceita paste de 6 dígitos no primeiro campo
          style: const TextStyle(
            fontSize: 22,
            fontWeight: FontWeight.w700,

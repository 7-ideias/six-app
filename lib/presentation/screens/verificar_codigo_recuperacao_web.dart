...
import 'nova_senha_web.dart';

class VerificarCodigoRecuperacaoWeb extends StatefulWidget {
  final String email;

  const VerificarCodigoRecuperacaoWeb({super.key, required this.email});

  @override
  State<VerificarCodigoRecuperacaoWeb> createState() =>
      _VerificarCodigoRecuperacaoWebState();
}
  ...
  Future<void> _validar() async {
    ...
    try {
      ...
      Navigator.push(
        context,
        MaterialPageRoute(
          builder: (_) => NovaSenhaWeb(email: widget.email, codigo: code),
        ),
      );
    } on RecuperacaoSenhaException catch (e) {
      _showSnack(e.message);
      ...
      child: Focus(
        ...
        child: TextField(
          ...
          decoration: InputDecoration(
            counterText: '',
            filled: true,
            fillColor: WebAuthShell.fieldFill(),

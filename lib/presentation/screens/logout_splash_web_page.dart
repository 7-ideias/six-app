...
class LogoutSplashWebPage extends StatefulWidget {
  const LogoutSplashWebPage({super.key});

  @override
  State<LogoutSplashWebPage> createState() => _LogoutSplashWebPageState();
}

class _LogoutSplashWebPageState extends State<LogoutSplashWebPage>
  ...
  PageRouteBuilder<void> _fadeToLoginRoute() {
    return PageRouteBuilder<void>(
      settings: const RouteSettings(name: '/login'),
      transitionDuration: const Duration(milliseconds: 680),
      reverseTransitionDuration: const Duration(milliseconds: 420),
      pageBuilder: (_, __, ___) => const LoginPageWeb(),
        ...
        child: Align(
          ...
          child: Opacity(
            ...
            child: Transform.scale(
              scale: 1.9,
              child: _LogoutLogoConstellation(
                size: size,
                progress: progress,
              ),
            ),

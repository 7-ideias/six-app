...
class _OrcamentoWebState extends State<OrcamentoWeb> {
  ...
  final TextEditingController _clienteDocumentoController =
      TextEditingController(text: '123.456.789-00');
  final TextEditingController _responsavelComercialController =
      TextEditingController(text: 'Juliana Rocha');
  ...
  _observacoesTecnicasController = TextEditingController(
    text:
  ...
  final TextEditingController
  _observacoesFinaisController = TextEditingController(
    text:
        'Mock local pronto para futura integração com backend e conversão em OS.',
  );
  ...
  final List<Map<String, dynamic>> _checklist = <Map<String, dynamic>>[
    ...
    <String, dynamic>{
      ...
      'descricao': 'Touchscreen responde corretamente.',
      'ok': false,
    },
    <String, dynamic>{
  ...
  List<Map<String, dynamic>> get _steps => const <Map<String, dynamic>>[
    <String, dynamic>{
      'titulo': 'Cliente',
      'descricao': 'Quem solicita e contexto comercial',
      'icone': Icons.person_outline,
    },
    <String, dynamic>{
      'titulo': 'Equipamento',
      'descricao': 'Entrada, identificação e acessórios',
      'icone': Icons.devices_other_outlined,
    },
    <String, dynamic>{
      'titulo': 'Diagnóstico',
      'descricao': 'Defeito e checklist técnico',
    ...
    <String, dynamic>{
      'titulo': 'Condições',
      'descricao': 'Prazo, canais e conversão futura em OS',
  ...
  double _totalSelecionado() {
    return _itens
        .where((Map<String, dynamic> item) => item['selecionado'] == true)
        .fold<double>(
          0,
          ...
          children: <Widget>[
            Wrap(
              ...
              children: <Widget>[
                ...
                OutlinedButton.icon(
                  onPressed: _selecionarResponsavel,
                  icon: const Icon(Icons.badge_outlined),
                  label: const Text('Selecionar responsável comercial'),
                ),
                OutlinedButton.icon(
                  onPressed:
              ...
              children: <Widget>[
                SizedBox(
                  ...
                  child: SwitchListTile(
                    ...
                    subtitle: const Text(
                      'Separar unidade reserva enquanto a análise estiver em andamento.',
                    ),
                ...
                SizedBox(
                  ...
                  child: SwitchListTile(
                    ...
                    subtitle: const Text(
                      'Preparar futuras automações por WhatsApp, e-mail e Telegram.',
                    ),
                    shape: RoundedRectangleBorder(
                      borderRadius: BorderRadius.circular(18),
                      side: BorderSide(
                ...
                onPressed:
                    () => setState(() {
                      _itens.add(<String, dynamic>{
                        ...
                        'detalhe': 'Serviço incluído manualmente',
                        'quantidade': 1,
                        'valor': 120.0,
                        'selecionado': true,
                      });
        ...
        child: Column(
          children: <Widget>[
            ...
            Wrap(
              ...
              runSpacing: 12,
              children:
                  _canais.map((Map<String, dynamic> canal) {
              ...
              children: <Widget>[
                ...
                SizedBox(
                  ...
                  child: SwitchListTile(
                    ...
                    subtitle: const Text(
                      'Mantém o orçamento pronto para futura automação multicanal.',
                    ),
                    shape: RoundedRectangleBorder(
                      borderRadius: BorderRadius.circular(18),
                      side: BorderSide(
              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    _infoRow(
                      'Responsável',
                      _responsavelComercialController.text,
                    ),
                    ...
                    FilledButton.icon(
                      onPressed:
                          () => _showInfo(
                            'Orçamento pronto',
                            'Fluxo mock concluído. Na próxima etapa você pode conectar persistência, PDF, link público e conversão para OS.',
                          ),
                    ...
                    OutlinedButton.icon(
                      onPressed:
                          () => _showInfo(
                            'Converter em OS',
                            'O desenho já foi preparado para manter orçamento e ordem de serviço separados, com conversão futura a partir do backend.',
                          ),
              ...
              FilledButton.icon(
                onPressed: () {
                  if (last) {
                    _showInfo(
                      'Orçamento concluído',
                      'Fluxo mock finalizado com cliente e colaborador integrados ao processo.',
                    );
                    return;
                  }
                  _irParaEtapa(_step + 1);
                ...
                icon: Icon(
                  last ? Icons.check_circle_outline : Icons.arrow_forward,
                ),
  ...
  Widget build(BuildContext context) {
                  ...
                  children: <Widget>[
                    Expanded(
                      child: PageView(
                        ...
                        onPageChanged:
                            (int index) => setState(() => _step = index),
                        children: pages,
                      ),
                    ),
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(context.t('web.standalone.quote', fallback: 'Orçamento')),
      ),
      body: body,
    );
  }

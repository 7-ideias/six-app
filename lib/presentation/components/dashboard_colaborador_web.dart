...
class DashboardColaboradorWeb extends StatefulWidget {
  const DashboardColaboradorWeb({super.key});

  @override
  State<DashboardColaboradorWeb> createState() =>
      _DashboardColaboradorWebState();
}

class _DashboardColaboradorWebState
    extends State<DashboardColaboradorWeb> {

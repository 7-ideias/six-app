...
class AtendimentoTecnicoApiClient {
  ...
  Future<AtendimentoTecnicoStatusPublicoLinkModel> gerarLinkStatusPublico({
    ...
    final response = await _httpClient.post(
      Uri.parse(
        '${AppConfig.baseUrl}/atendimentos-tecnicos/$id/status-publico/link',
      ),
      headers: await _headers(),
      body: jsonEncode(<String, dynamic>{
        'baseUrl': baseUrl,
    ...
    return AtendimentoTecnicoStatusPublicoLinkModel.fromJson(
      jsonDecode(_decodeBody(response)) as Map<String, dynamic>,
    );
  }
  ...
  Future<AtendimentoTecnicoStatusPublicoModel> consultarStatusPublico({
    ...
    return AtendimentoTecnicoStatusPublicoModel.fromJson(
      jsonDecode(_decodeBody(response)) as Map<String, dynamic>,
    );
  }
  ...
  gerarLinkAssinaturaPeloStatusPublico({
    ...
    final response = await _httpClient.post(
      Uri.parse(
        '${AppConfig.baseUrl}/public/api/atendimentos-tecnicos/status/assinatura-link',
      ),
  ...
  Future<Map<String, dynamic>> aprovarAssinaturaPublica({
    ...
    final response = await _httpClient.post(
      Uri.parse(
        '${AppConfig.baseUrl}/public/api/atendimentos-tecnicos/assinatura/aprovar',
      ),
      headers: _publicHeaders(),
      body: jsonEncode(<String, dynamic>{
        'idUnicoDaEmpresa': idUnicoDaEmpresa,
...
class AtendimentoTecnicoApiException implements Exception {
  AtendimentoTecnicoApiException({
  ...
  @override
  String toString() =>
      'AtendimentoTecnicoApiException(statusCode: $statusCode, body: $body)';
}

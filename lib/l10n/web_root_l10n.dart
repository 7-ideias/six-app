      ...
      _code == 'en'
          ...
          ? [
            (
              ...
              pitch: 'Empieza a vender hoy, sin contratos.',
              features: [
                'Caja',
                'Hasta 50 productos',
                'Informes básicos',
            ...
            (
              ...
              price: '\$19',
              cadence: 'por mes',
              pitch: 'Para la mayoría de las tiendas que viven del mostrador.',
              features: [
                'Todo de Inicial',
                'Stock + IA de registro',
                'Órdenes de servicio',
                'Finanzas predictivas',
                'Soporte humano',
              ],
            ...
            (
              ...
              price: '\$49',
              cadence: 'por mes',
              pitch: 'Para quienes necesitan panel ejecutivo.',
              features: [
                'Todo de Profesional',
                'Cockpit estratégico',
                'Múltiples sucursales',
                'Acceso por colaborador',
                'Soporte dedicado',
              ],
          ...
          : [
            ...
            (
              ...
              cadence: 'por mês',
              pitch:
                  'Para a maioria das lojas que vivem do balcão e do WhatsApp.',
              features: [
                'Tudo do Inicial',
